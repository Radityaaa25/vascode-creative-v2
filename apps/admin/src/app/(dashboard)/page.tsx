...
export default function DashboardPage() {
  ...
  if (error && !data) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-3 text-white/60">
        ...
        <button onClick={() => setTimeRange(timeRange)} className="mt-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-semibold hover:bg-white/10">
          Retry
        </button>
      </div>
    );
