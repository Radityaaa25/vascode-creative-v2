    ...
    <>
      <style>{`
        .cta-btn {
          ...
          background: #6225e6;
          transition: 1s;
          box-shadow: 4px 4px 0 hsl(240, 5%, 5%);
        ...
        .cta-btn:hover {
          transition: 0.5s;
          box-shadow: 6px 6px 0 hsl(var(--accent));
        }

        .cta-btn .second-arrow {
          transition: 0.5s;
          margin-right: 0px;
        }

        .cta-btn:hover .second-arrow {
          transition: 0.5s;
          margin-right: 15px;
        }
      ...
      <button className="cta-btn">
        ...
        <span className="second-arrow">
          <svg width="24px" height="12px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
